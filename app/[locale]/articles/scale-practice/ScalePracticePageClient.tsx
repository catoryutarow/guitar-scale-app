...
export default function ScalePracticePageClient() {
  const { t } = useLanguage();
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <ul className="space-y-3">
              <li>
                <LocaleLink href="/articles/pentatonic-basics" className="text-blue-600 hover:text-blue-800">
                  → {t.pentatonicTitle}
                </LocaleLink>
              </li>
              <li>
              ...
              <li>
                <LocaleLink href="/articles/harmonic-minor" className="text-blue-600 hover:text-blue-800">
                  → {t.harmonicTitle}
                </LocaleLink>
              </li>
            </ul>
