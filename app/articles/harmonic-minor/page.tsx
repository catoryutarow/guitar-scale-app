...
export default function HarmonicMinorPage() {
  const { t } = useLanguage();
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/articles/blues-scale" className="text-blue-600 hover:text-blue-800">
                  → {t.bluesTitle}
                </Link>
              </li>
              <li>
                <Link href="/articles/scale-practice" className="text-blue-600 hover:text-blue-800">
                  → {t.practiceTitle}
                </Link>
              </li>
            </ul>
