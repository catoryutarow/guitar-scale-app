...
export default function ModeScalesPage() {
  const { t } = useLanguage();
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <div className="bg-blue-50 rounded-xl p-8 text-center">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link href="/?note=D&scale=ドリアン" className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm">
                D Dorian
              </Link>
              <Link href="/?note=E&scale=フリジアン" className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm">
                E Phrygian
              </Link>
              <Link href="/?note=F&scale=リディアン" className="px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors text-sm">
                F Lydian
              </Link>
              <Link href="/?note=G&scale=ミクソリディアン" className="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors text-sm">
                G Mixolydian
              </Link>
            </div>
          </div>
